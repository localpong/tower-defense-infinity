...
const WALK_EMOJIS = [
  // ด่าน 1: ทุ่งหญ้า (Grassland)
  ['🧌', '🧌'], // 0: โทรลล์ (ถึก/พืช แพ้ไฟ)
  ['👺', '👺'], // 1: ก๊อบลิน (เร็ว/พืช แพ้ไฟ)
  ['🦅', '🦅'], // 2: นกยักษ์ (บิน แพ้สายฟ้า)
  ['🧙', '🧙'], // 3: พ่อมดก๊อบลิน (ยิงไกล/มืด แพ้เวท)
  // ด่าน 2: ป่าทึบ (Forest)
  ['🕷️', '🕷️'], // 4: แมงมุม (ถึก/แมลง แพ้น้ำแข็ง)
  ['🐺', '🐺'], // 5: หมาป่า (เร็ว/สัตว์ แพ้น้ำแข็ง)
  ['🐝', '🐝'], // 6: ผึ้งนักฆ่า (บิน แพ้สายฟ้า)
  ['🥀', '🥀'], // 7: ดอกไม้กินคน (ยิงไกล/พืช แพ้ไฟ)
  // ด่าน 3: ทะเลทราย (Desert)
  ['🪨', '🪨'], // 8: โกเลมทราย (ถึก/ดิน แพ้น้ำแข็ง กันสายฟ้า)
  ['🦂', '🦂'], // 9: แมงป่อง (เร็ว/แมลง แพ้น้ำแข็ง)
  ['🦇', '🦇'], // 10: ค้างคาวทราย (บิน แพ้สายฟ้า)
  ['🥷', '🥷'], // 11: โจรทะเลทราย (ยิงไกล/มืด แพ้เวท)
  // ด่าน 4: ภูเขาไฟ (Volcano)
  ['🌋', '🌋'], // 12: โกเลมลาวา (ถึก/ไฟ แพ้น้ำแข็ง กันไฟ)
  ['🦖', '🦖'], // 13: กิ้งก่าไฟ (เร็ว/สัตว์ แพ้น้ำแข็ง กันไฟ)
  ['🐉', '🐉'], // 14: ลูกมังกร (บิน แพ้สายฟ้า กันไฟ)
  ['👿', '👿'], // 15: อิมป์ (ยิงไกล/มืด แพ้เวท กันไฟ)
  // ด่าน 5: ดินแดนน้ำแข็ง (Ice)
  ['⛄', '⛄'], // 16: เยติ (ถึก/น้ำแข็ง แพ้ไฟ กันน้ำแข็ง)
  ['🐻‍❄️', '🐻‍❄️'], // 17: หมีขาว (เร็ว/สัตว์ แพ้ไฟ กันน้ำแข็ง)
  ['🦉', '🦉'], // 18: นกฮูกหิมะ (บิน แพ้สายฟ้า กันน้ำแข็ง)
  ['👻', '👻']  // 19: วิญญาณน้ำแข็ง (ยิงไกล/มืด แพ้เวท กันน้ำแข็ง)
];
